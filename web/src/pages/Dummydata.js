...
export const notifikasi = [
  { id: 1, pesan: "Jadwal Posyandu Melati besok pukul 08.00", waktu: "1 jam lalu", dibaca: false, tipe: "jadwal" },
  { id: 2, pesan: "Aisyah Budi perlu imunisasi Campak bulan ini", waktu: "3 jam lalu", dibaca: false, tipe: "imunisasi" },
  { id: 3, pesan: "Laporan bulanan April telah berhasil dikirim", waktu: "1 hari lalu", dibaca: true, tipe: "laporan" },
  { id: 4, pesan: "Data rujukan Nayla Fitri diperbarui", waktu: "2 hari lalu", dibaca: true, tipe: "rujukan" },
];
...
export const statsAdmin = {
  ...
  totalPosyandu: 32,
  totalWilayah: 11,
  persentaseStunting: 7.9,
  trendStunting: [
    { bulan: "Nov", nilai: 9.2 }, { bulan: "Des", nilai: 8.8 },
    { bulan: "Jan", nilai: 8.5 }, { bulan: "Feb", nilai: 8.1 },
    { bulan: "Mar", nilai: 7.9 }, { bulan: "Apr", nilai: 7.9 },
  ],
  distribusiGizi: [
    { status: "Normal", jumlah: 185, persen: 81.9 },
    { status: "Gizi Kurang", jumlah: 23, persen: 10.2 },
    { status: "Gizi Lebih", jumlah: 12, persen: 5.3 },
    { status: "Stunting", jumlah: 6, persen: 2.6 },
  ],
  stuntingPerKecamatan: [
    { nama: "Koto Tangah", jumlah: 4 },
    { nama: "Padang Utara", jumlah: 3 },
    { nama: "Lubuk Kilangan", jumlah: 5 },
    { nama: "Padang Selatan", jumlah: 2 },
    { nama: "Kuranji", jumlah: 4 },
  ]
};

export const kmsData = {
  bbPerUsia: [
    { usia: 0, nilai: 3.2, median: 3.3, plus2: 4.4, minus2: 2.1 },
    { usia: 3, nilai: 5.8, median: 6.0, plus2: 7.5, minus2: 4.4 },
    { usia: 6, nilai: 7.1, median: 7.3, plus2: 9.0, minus2: 5.7 },
    { usia: 9, nilai: 8.2, median: 8.9, plus2: 10.6, minus2: 7.2 },
    { usia: 12, nilai: 9.5, median: 9.6, plus2: 11.5, minus2: 7.7 },
    { usia: 18, nilai: 10.8, median: 10.9, plus2: 13.2, minus2: 8.8 },
    { usia: 24, nilai: 11.9, median: 12.2, plus2: 14.8, minus2: 9.7 },
  ],
  tbPerUsia: [
    { usia: 0, nilai: 49, median: 49.9, plus2: 53.4, minus2: 46.3 },
    { usia: 3, nilai: 60, median: 61.4, plus2: 65.5, minus2: 57.3 },
    { usia: 6, nilai: 67, median: 67.6, plus2: 72.1, minus2: 63.3 },
    { usia: 9, nilai: 72, median: 72.3, plus2: 77.5, minus2: 67.7 },
    { usia: 12, nilai: 75, median: 75.7, plus2: 81.2, minus2: 70.6 },
    { usia: 18, nilai: 82, median: 82.3, plus2: 87.7, minus2: 77.2 },
    { usia: 24, nilai: 87, median: 87.8, plus2: 93.5, minus2: 82.5 },
  ],
};