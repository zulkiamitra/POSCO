...
class OrangTuaRiwayatDetailScreen extends StatelessWidget {
  const OrangTuaRiwayatDetailScreen({
    super.key,
    this.date,
    this.location,
    this.status,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          childName != null ? 'DETAIL: ${childName!.toUpperCase()}' : 'DETAIL PEMERIKSAAN',
